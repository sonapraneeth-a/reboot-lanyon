/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+bash+cpp+markup-templating+latex+markdown+python+yaml&plugins=line-highlight+line-numbers+autolinker+file-highlight+toolbar+jsonp-highlight+highlight-keywords+command-line+normalize-whitespace+data-uri-highlight+show-language+copy-to-clipboard */
